...
class ExactGPModel(gpytorch.models.ExactGP):
    def __init__(self, train_x, train_y, likelihood):
        ...
        self.covar_module = gpytorch.kernels.ScaleKernel(  DotProductKernel(offset_constraint=gpytorch.constraints.Interval(-1800., 1800.)), outputscale_constraint=gpytorch.constraints.GreaterThan(1) )
    ...
    def reset(self):
        ...
        self.covar_module.base_kernel.offset = torch.rand(1)
...
output_f.write( str(model.covar_module.base_kernel.offset) + '\n')
