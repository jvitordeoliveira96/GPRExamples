...
output_f = open('../logs/f4/SM_'+str(n_gaussians_Q)+'gauss_.txt', 'w')
...
# model.covar_module.mixture_means = torch.tensor([9.9993e-01,
#  1.4435,
#  7.6980e-04,
#  2.3940e+00])

# model.covar_module.mixture_scales = torch.tensor([[[0.0135]],
...
# model.covar_module.mixture_weights = torch.tensor([ 2.6057,  3.9462, 26.8396,  2.9192])
...
with torch.no_grad():
    ...
    tikzplt.save('../results/tikz/f4/SM_'+str(n_gaussians_Q)+'gauss_.tex')
    plt.show()