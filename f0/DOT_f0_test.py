...
class ExactGPModel(gpytorch.models.ExactGP):
    def __init__(self, train_x, train_y, likelihood):
        ...
        self.covar_module = gpytorch.kernels.ScaleKernel( DotProductKernel() ) 
...
model.covar_module.base_kernel.offset = 1.0
...
with torch.no_grad(), gpytorch.settings.prior_mode(True):
    ...
    ax.fill_between(test_x.detach().numpy(), lower.detach().numpy() + 0.1 , upper.detach().numpy() - 0.1, alpha=0.3, color = 'pink')
