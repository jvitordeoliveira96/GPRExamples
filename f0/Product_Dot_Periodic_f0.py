...
class ExactGPModel(gpytorch.models.ExactGP):
    def __init__(self, train_x, train_y, likelihood):
        ...
        self.covar_module = gpytorch.kernels.ScaleKernel(gpytorch.kernels.PeriodicKernel() * DotProductKernel() )
...
# Periodic
model.covar_module.base_kernel.kernels[0].period_length = 30
model.covar_module.base_kernel.kernels[0].lengthscale = 1
# Dot
model.covar_module.base_kernel.kernels[1].offset = 0
model.covar_module.outputscale = 0.25
model.likelihood.noise = 1e-11
