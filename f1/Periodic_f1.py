...
class ExactGPModel(gpytorch.models.ExactGP):
    ...
    def reset(self):
        ...
        self.covar_module.base_kernel.period_length = torch.rand(1)
...
output_f.write('Period length: \n')
output_f.write( str(model.covar_module.base_kernel.period_length.item()) + '\n')
