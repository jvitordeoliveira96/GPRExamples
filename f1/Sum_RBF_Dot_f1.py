...
class ExactGPModel(gpytorch.models.ExactGP):
    ...
    def reset(self):
        # RBF
        self.covar_module.kernels[0].outputscale = torch.rand(1) * torch.max(train_y)
        self.covar_module.kernels[0].base_kernel.lengthscale = torch.rand(1)
        # Dot
        self.covar_module.kernels[1].outputscale = torch.rand(1) * torch.max(train_y)
        self.covar_module.kernels[1].base_kernel.offset = torch.rand(1)
...
output_f.write( str(model.covar_module.kernels[0].outputscale) + '\n')
output_f.write('Lengthscale: \n')
output_f.write( str(model.covar_module.kernels[0].base_kernel.lengthscale.item()) + '\n')
output_f.write('Dot: \n')
output_f.write('Scale (signal variance): \n')
output_f.write( str(model.covar_module.kernels[1].outputscale) + '\n')
output_f.write('Offset: \n')
output_f.write( str(model.covar_module.kernels[1].base_kernel.offset) + '\n')
