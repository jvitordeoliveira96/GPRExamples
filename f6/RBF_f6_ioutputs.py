...
path = '../logs/f6/RBF_IndOutputs.txt'
...
# Pseudo individual (same output scale)
model.covar_module.outputscale = torch.mean(model.covar_module.outputscale) * torch.ones( model.covar_module.outputscale.size() )  
